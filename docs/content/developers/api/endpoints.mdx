...
This page provides an overview of the API endpoint groups available in OmniLearn. All endpoints are prefixed with `/api/v1/`. For the full interactive reference with request and response schemas, visit the Swagger UI at `/docs` on a development instance.
...
## Standard Features (Standard Plan)
