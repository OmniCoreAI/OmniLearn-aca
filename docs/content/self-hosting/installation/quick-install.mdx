...
Follow these steps to install and start a self-hosted OmniLearn instance using the OmniLearn CLI.
...
The wizard generates `docker-compose.yml`, `.env`, `omnilearn.config.json`, and an nginx or Caddy configuration based on your choices. Sensible defaults are provided for most options -- you can press Enter to accept them and adjust settings later.

## Step 2: Start OmniLearn
...
## Step 3: Access OmniLearn

Once all services are running, access OmniLearn at your configured domain or:
