...
function Navbar() {
  ...
  const logoSrc = '/img/logos/omnilearn-dark.svg'
    ...
    <>
        ...
        <div className="lh-navbar-inner">
          ...
          <div className="lh-navbar-left">
            ...
            <nav className="lh-navbar-nav lh-hide-mobile">
              ...
              <a
                href="https://university.omnilearn.io"
                target="_blank"
              ...
              <a
                href="https://omnilearn.app/integrations"
                target="_blank"
                rel="noopener noreferrer"
                className="lh-navbar-nav-item"
              >
          ...
          <div className="lh-navbar-right">
            ...
            <a
              href="https://github.com/omnilearn/omnilearn"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={`lh-mobile-drawer ${mobileMenuOpen ? 'lh-mobile-drawer-open' : ''}`}>
        <div className="lh-mobile-drawer-links">
          ...
          <a href="https://university.omnilearn.io" target="_blank" rel="noopener noreferrer" className="lh-mobile-drawer-link">
            <GraduationCap size={16} weight="fill" />
            Learn
            <ArrowUpRight size={12} weight="bold" />
          </a>
          <a href="https://omnilearn.app/integrations" target="_blank" rel="noopener noreferrer" className="lh-mobile-drawer-link">
            <Plug size={16} weight="fill" />
            Integrations
            <ArrowUpRight size={12} weight="bold" />
          </a>
          <a href="https://omnilearn.app" target="_blank" rel="noopener noreferrer" className="lh-mobile-drawer-link">
            <Globe size={16} weight="fill" />
            Website
            <ArrowUpRight size={12} weight="bold" />
          </a>
          <a href="https://github.com/omnilearn/omnilearn" target="_blank" rel="noopener noreferrer" className="lh-mobile-drawer-link">
            <GithubLogo size={16} weight="fill" />
            GitHub
          </a>
