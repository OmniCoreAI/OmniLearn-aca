  ...
  index: [
    {
      ...
      desc: 'Ship your own headless learning platform with Next.js and the OmniLearn API — anonymous browsing first, then auth, enrollment and progress.',
    },
    {
      ...
      desc: 'Drive the API with tokens, automate with webhooks, and extend OmniLearn with your own integrations.',
    },
  ],
