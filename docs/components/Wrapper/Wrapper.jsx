...
function EditOnGitHub({ filePath }) {
  ...
  // lives under docs/ in the omnilearn monorepo, so prefix with that. Using it
  // directly avoids guessing folder-index vs leaf-file from the URL.
  if (!filePath) return null

  const href = `https://github.com/omnilearn/omnilearn/edit/dev/docs/${filePath}`
    ...
    >
      ...
      <div className="relative p-4">
        <div className="flex items-center gap-2.5" style={{ marginBottom: 16 }}>
          <img src="/img/logos/omnilearn-dark.svg" alt="OmniLearn" className="h-3.5" />
          <span
