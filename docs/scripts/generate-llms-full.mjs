...
const SITE_URL = 'https://docs.omnilearn.app'
...
sections.push('# OmniLearn Documentation — Full Content')
sections.push('')
sections.push('> This file contains the complete text of all OmniLearn documentation pages.')
