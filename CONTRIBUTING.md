...
To set up your development environment, use the OmniLearn CLI:
...
- Start an issue [here](https://github.com/omnilearn/omnilearn/issues) to report the bug.
...
- Start a Discussion [here](https://github.com/omnilearn/omnilearn/discussions/categories/ideas) to propose your idea and how it should be implemented.
