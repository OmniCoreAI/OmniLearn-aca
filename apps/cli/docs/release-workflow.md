...
How to release a new version of the OmniLearn CLI to npm.

## Prerequisites

- npm org `omnilearn` created on [npmjs.com](https://www.npmjs.com)
...
- **npm:** https://www.npmjs.com/package/omnilearn — should show the new version
- **GitHub:** Releases page shows the new release
- **Test:** `npx omnilearn@latest --version` prints the new version
...
- Token must have publish permissions for the `omnilearn` package
