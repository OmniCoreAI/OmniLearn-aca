# ─────────────────────────────────────────────────────────────
# OmniLearn — Install Script (Windows PowerShell)
...
Write-Host ""
Write-Host "OmniLearn Installer" -ForegroundColor White -NoNewline
Write-Host ""
...
Write-Host ""
Write-Host "  Run OmniLearn with:" -ForegroundColor DarkGray
Write-Host "  npx omnilearn@latest" -ForegroundColor Cyan
Write-Host ""

# ── Launch ───────────────────────────────────────────────────

Write-Host "Launching OmniLearn..." -ForegroundColor Cyan
Write-Host ""
& npx omnilearn@latest
