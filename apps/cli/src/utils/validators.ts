...
// RFC 2606 reserved second-level domains. The OmniLearn seeder rejects these,
...
export function validateDomain(value: string): string | undefined {
  ...
  if (!re.test(value)) return 'Please enter a valid domain (e.g., omnilearn.example.com)'
  return undefined
}
