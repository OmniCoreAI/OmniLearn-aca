...
async function showWelcome() {
  ...
  console.log()
  console.log(pc.dim('  Run a command with: npx omnilearn <command>'))
  console.log(pc.dim('  Get started with:   npx omnilearn setup'))
  console.log()
}
...
program
  .name('omnilearn')
  .description('The official OmniLearn CLI — deploy, manage, and operate your OmniLearn instance')
  .version(VERSION)
  .action(showWelcome)

program
  .command('setup')
  .description('Interactive setup wizard for OmniLearn')
...
program
  .command('start')
  .description('Start OmniLearn services')
  .action(startCommand)

program
  .command('stop')
  .description('Stop OmniLearn services')
  .action(stopCommand)

program
  .command('logs')
  .description('Stream logs from OmniLearn services')
  .action(logsCommand)

program
  .command('config')
  .description('Show current OmniLearn configuration')
  .action(configCommand)

program
  .command('backup')
  .description('Backup & restore OmniLearn database')
...
program
  .command('doctor')
  .description('Diagnose common issues with OmniLearn')
  .action(doctorCommand)

program
  .command('shell')
  .description('Open a shell in a OmniLearn container')
  .action(shellCommand)

program
  .command('update')
  .description('Update OmniLearn to latest or a specific version (EE: backs up the DB + runs migrations)')
