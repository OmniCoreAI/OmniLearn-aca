"""
Admin API Router — Headless access to OmniLearn via API tokens.
...
def _support_url() -> str:
    """Return the OmniLearn support page URL (platform URL, not org-specific)."""
    platform = os.environ.get("OMNILEARN_PLATFORM_URL", "https://www.omnilearn.app").rstrip("/")
...
<title>Sign-in link — OmniLearn</title>
<style>
