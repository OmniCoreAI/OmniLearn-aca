...
@router.get(
    "/config",
    summary="Get OmniLearn runtime config",
    description="Returns the current OmniLearn configuration with sensitive values redacted. Restricted to superadmin users.",
    responses={
