...
def get_content_delivery_type() -> str:
    ...
    return omnilearn_config.hosting_config.content_delivery.type
...
def get_s3_bucket_name() -> str:
    ...
    omnilearn_config = get_omnilearn_config()
    return omnilearn_config.hosting_config.content_delivery.s3api.bucket_name or "omnilearn-media"
