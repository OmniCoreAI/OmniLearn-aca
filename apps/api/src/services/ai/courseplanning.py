...
OL_CONFIG = get_omnilearn_config()
...
def get_redis_connection():
    ...
    redis_conn_string = OL_CONFIG.redis_config.redis_connection_string
...
Activities in OmniLearn use a rich content editor with various block types. For each activity, suggest appropriate blocks:
