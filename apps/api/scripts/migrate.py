#!/usr/bin/env python3
"""
Unified migration script for OmniLearn database updates.
...
def get_database_url():
    ...
    return os.environ.get(
        ...
        os.environ.get(
            'OMNILEARN_DB_URL',
            'postgresql://omnilearn:omnilearn@localhost:5432/omnilearn'
        )
    )
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='OmniLearn Database Migration Script',
...
Examples:
  ...
  python scripts/migrate.py boards       Run only boards migration
    ...
    print("=" * 60)
    print("OmniLearn Database Migration Script")
    print("=" * 60)
