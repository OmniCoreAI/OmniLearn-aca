 ...
 *  - a self-host the suite boots itself via the OmniLearn CLI (default), or
...
/** CLI install name (also the docker-compose project dir under ~/.omnilearn). */
...
export const CLI = process.env.E2E_CLI || 'npx --yes omnilearn@latest'
