 ...
 *
 * Boots a real OmniLearn self-host using the OmniLearn CLI (`setup --ci`,
...
function bootSelfHost(): void {
  console.log(`Booting OmniLearn self-host via CLI (install "${INSTALL_NAME}")…`)
  const cmd = [
    CLI,
    'setup',
    '--ci',
...
export default async function globalSetup(): Promise<void> {
  ...
  console.log(`OmniLearn is ready at ${BASE_URL}. Admin: ${ADMIN_EMAIL}`)
