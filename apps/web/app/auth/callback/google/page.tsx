...
import { getOMNILEARN_DOMAIN_VAL } from '@services/config/config'
...
export default function GoogleCallbackPage() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      // Google redirects to the main domain (dev.omnilearn.io). We detect this
