...
import { getOMNILEARN_TOP_DOMAIN_VAL } from '@services/config/config'
...
function InviteOnlySignUpComponent(props: InviteOnlySignUpProps) {
  ...
  const handleGoogleSignIn = () => {
    ...
    if (org?.slug) {
      ...
      document.cookie = `OL_oauth_orgslug=${org.slug}${baseAttributes}${domainAttr}`;
      document.cookie = `OL_oauth_org_id=${org.id}${baseAttributes}${domainAttr}`;
    }
