...
const BACKEND_URL = (process.env.NEXT_PUBLIC_OMNILEARN_BACKEND_URL || 'http://localhost:1338').replace(/\/+$/, '')

// Cookie names (must match the API routes)
const ACCESS_TOKEN_COOKIE = 'OL_access'
const REFRESH_TOKEN_COOKIE = 'OL_refresh'
