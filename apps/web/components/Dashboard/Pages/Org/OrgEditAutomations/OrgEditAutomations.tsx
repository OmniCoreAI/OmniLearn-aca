...
const OrgEditAutomations: React.FC = () => {
  ...
  // Zapier hero card stays hidden until the OmniLearn Zapier app is live
  const showZapierHeroCard = false

  return (
    <FeatureGate feature="webhooks">
      <>
        {/* ── Zapier hero card (hidden until the OmniLearn Zapier app is live) ────────────────────── */}
        {showZapierHeroCard && (
          ...
          <div className="px-5 py-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-500 text-xs mt-0.5">
                Connect OmniLearn to thousands of apps without writing code.
              </p>
            </div>
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <a
                href="https://zapier.com/apps/omnilearn/integrations"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
...
// Zapier-managed webhooks are read-only from OmniLearn's side — the Zap itself
