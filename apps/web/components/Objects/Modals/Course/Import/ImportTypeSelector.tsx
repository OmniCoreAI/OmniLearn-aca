...
interface ImportTypeSelectorProps {
  onSelectType: (type: 'scorm' | 'omnilearn') => void
  ...
  return (
    <div className="min-w-[400px] py-2">
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* OmniLearn Import Option */}
        <button
          onClick={() => onSelectType('omnilearn')}
        ...
        >
          ...
          <h3 className="font-semibold text-gray-900 mb-1">
            {t('courses.import.omnilearn_courses')}
          </h3>
          <p className="text-sm text-gray-500 text-center">
            {t('courses.import.omnilearn_description')}
          </p>
        </button>
      </div>
    </div>
