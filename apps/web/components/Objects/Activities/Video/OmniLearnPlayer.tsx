...
const OmniLearnPlayer: React.FC<OmniLearnPlayerProps> = ({
  src,
  details,
  onReady,
  poster,
  ...
  return (
    <div
      ref={containerRef}
      className={`omnilearn-player relative w-full aspect-video overflow-hidden bg-black ${
...
export default OmniLearnPlayer
