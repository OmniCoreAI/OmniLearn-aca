...
export default function AuthBrandingPanel({ org, welcomeText }: AuthBrandingPanelProps) {
  ...
  // Check if org has enterprise plan - hide OmniLearn branding for enterprise users
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-10">
        {/* Top bar with OmniLearn lrn.svg logo - hidden for enterprise users */}
        {!isEnterprise && (
          <div className="login-topbar">
            <Link prefetch href="https://omnilearn.app" target="_blank">
              <img
                src="/lrn.svg"
                alt="OmniLearn"
                width={30}
