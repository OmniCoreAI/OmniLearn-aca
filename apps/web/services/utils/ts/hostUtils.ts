 ...
 * isSubdomainOf("acme.omnilearn.io:3000", "omnilearn.io") -> true
 * isSubdomainOf("omnilearn.io", "omnilearn.io") -> false (same host, not a subdomain)
 */
 ...
 * Both may include ports — ports are stripped before comparison.
 * extractSubdomain("acme.omnilearn.io:3000", "omnilearn.io") -> "acme"
 * extractSubdomain("omnilearn.io", "omnilearn.io") -> null
 * extractSubdomain("localhost", "omnilearn.io") -> null
 */
