          ...
          nestedIframes?.forEach((nestedIframe: HTMLIFrameElement) => {
            try {
              if (nestedIframe.contentDocument) {
                ...
                nestedStyle.id = 'omnilearn-scorm-styles'
                ...
                `
                // Remove any existing omnilearn styles first
                const existing = nestedIframe.contentDocument.getElementById('omnilearn-scorm-styles')
