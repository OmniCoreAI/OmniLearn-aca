...
let SENTRY_DSN = process.env.NEXT_PUBLIC_OMNILEARN_SENTRY_DSN;
let OMNILEARN_ENV = process.env.NEXT_PUBLIC_OMNILEARN_ENV || "dev";
  ...
  for (const configPath of possiblePaths) {
    try {
      if (fs.existsSync(configPath)) {
        ...
        SENTRY_DSN = rc.NEXT_PUBLIC_OMNILEARN_SENTRY_DSN || SENTRY_DSN;
        OMNILEARN_ENV = rc.NEXT_PUBLIC_OMNILEARN_ENV || OMNILEARN_ENV;
        break;
      }
    } catch {
