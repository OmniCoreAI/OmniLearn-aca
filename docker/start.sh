...
pm2 start server-wrapper.js --cwd /app/web --name omnilearn-web > /dev/null 2>&1
pm2 start uv --cwd /app/api --name omnilearn-api -- run app.py
pm2 start node --cwd /app/collab --name omnilearn-collab -- dist/index.js
